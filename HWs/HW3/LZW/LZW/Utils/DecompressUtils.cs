...
/// </summary>
public static class DecompressUtils
{
    /// <summary>
    ...
    public static List<int> GetAllCodes(byte[] bytes)
    {
    ...
    public static Dictionary<int, List<byte>> CreateAndInitializationOfDictionary()
    {
